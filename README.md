...
This PoC demonstrates how to integrate with Auth0 with the following requirements in mind:
...
You will need to manually set up the account linking extension in the dashboard.
